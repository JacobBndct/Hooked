...
public class FishingDistanceManager : MonoBehaviour
{
    ...
    void Update()
    {
        newValue = PlayerCharacter.Instance.FishingDistance / PlayerCharacter.Instance.MaxFishingDistance;
